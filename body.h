...
/**
 * Gets the vertices of a body
 *
 * @param body a pointer to a body returned from body_init()
 * @return list_t of vertices of body
 */
list_t *body_get_vertices(body_t *body);

/**
 * Sets the angle of a body
 *
 * @param body a pointer to a body returned from body_init()
...
/**
 * Rotates a body by first rotating it back to its original position
 *
 * @param body a pointer to a body returned from body_init()
 * @param angle the angle to set the body to
 */
 ...
 *
 * @param body a pointer to a body returned from body_init()
 * @param info the info that should be associated with the body
 */
void body_set_info(body_t *body, void *info);

bool body_get_grav(body_t *body);

void body_reset_force(body_t *body);

vector_t body_get_force(body_t *body);

bool body_get_prev_collision(body_t *body);

void body_set_prev_collision(body_t *body, bool prev);

void body_set_grav(body_t *body, bool grav);
 ...
 *
 * @param body a pointer to a body returned from body_init()
 * @param color an rgb color type associated with the body
 */
 ...
 * Note that the angle is *absolute*, not relative to the current
 * orientation.
 *
 * @param body a pointer to a body returned from body_init()
 * @param angle the body's new angle in radians. Positive is
 * counterclockwise.
 */
